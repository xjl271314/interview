...
```js
面试官你好，我叫许将龙，今年28岁，浙江台州人，计算机相关专业毕业，目前从事前端相关工作已有6年之余。

自工作以来主要深耕于PC、H5、公众号、小程序、Hybrid App等方向，业务范围主要囊括了电商、金融、直播、拍卖行等领域。

个人基础知识扎实，（有过多个全栈项目经验），擅长以React为主的相关技术栈，良好掌握了计算机相关原理以及工程化相关知识。

目前担任公司业务线内前端团队的Leader，负责核心业务直播和拍卖行相关的功能开发、团队资源统筹及成员带教相关的工作。在职期间带领团队完成了多次核心业务指标贡献，辅导了4位团队成员的转正和晋升工作。

此外我也是一个比较擅长总结和归纳的人，除了定期的在团队内部组织分享之外，
闲暇时间也沉淀了上百篇技术博客。

最后在性格上我是一个乐观、开朗、自律的人，擅长与人沟通，能够快速融入团队内部。
...
```js
我觉得我最大的优点是 适应能力强，执行力强，善于主动思考和沟通。

例如上一份工作，我花了大概2周不到的时间，整理出了一份所需负责业务的详细文档，并且迅速的融入到了团队内部中来，很快与每个团队成员混熟。在2周之后已经能够独立的负责相对应的功能。

在完成的同时，主动优化了现有功能逻辑，并提出了功能优化相关的建议，后期也安排了落地，在入职一个月后便收获了公司内部的业绩飞跃奖。
...
助人为乐本来是一个优点，但是不懂拒绝也带来了很多额外的烦恼。

在以往的日常工作中经常会碰到类似这些问题：

- 同事跑过来咨询这个问题怎么处理啊？
- 测试跑过来问看下这个逻辑？

在力所能及的情况下我总是会选择去帮助他们解决问题，但这有时候也打乱了自己的工作计划。

比如这个时候产品又跑过来说老板这里来了个紧急需求需要处理下，安排人来跟进下等？

在前期的时候我会尽力的去满足产品的所有要求，在资源有限的情况下也难免要去压榨组员的开发时间，本身项目就重的情况下，难免也会产生一些小情绪。

这种情况下，在合理的吐槽的同时，我自己也会起到一个带头作用，除了加班加点完成任务的同时，后期对内会组织周会，团建等方式沟通碰到的问题，舒缓大家的情绪，对外会向上反馈资源问题。

在后来，渐渐也学会了对抛开提升业务价值的为目的的需求需求Say No，对实验性的需求仅进行某个端的灰测开发，避免无意义的资源消耗。

在这种处理方式下，团队内部氛围一直保持良好，凝聚力也较强，大家沟通和工作起来都比较顺畅，业务指标也在稳定进步完成。
```
...
```js
首先，我并不排斥加班，在公司的高速发展过程中，难免会有因市场风向调整或者政策变动或者其他业务变动导致需要处理一些紧急的任务。

如果是因为个人原因导致既有项目排期存在进度风险的话，我会主动在工作日或者周末来加班保证项目的正常交付。

如果是协作方的原因，我会去和协作方沟通，询问碰到的困难点并及时进行解决。

如果是因为资源导致，将通过协调资源或者是调整需求的方式以寻求合适的解决方案。

另外我比较注重工作效率，每个需求会详细拆分到日任务，力求今日事今日毕。

最后我希望加班是有价值的，在为业务带来价值的同时自身也能够收获相对应的回报。
...
```js
目前我的规划是在未来5年内继续在前端相关的领域深耕。

在技术方面上保持持续关注和学习，拓宽自己视野的同时能够可视化、低代码等方向能够深入。

在以往工作中我发现自己在组织和管理能力上还不错，希望在未来能够多胜任团队及项目的管理上，能够带动整个团队成长，达到类似阿里P8的水平。

在收入方面上期望能够获得更高的收入，改善家庭的生活质量。
```
